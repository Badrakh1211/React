    ...
    <div className='container'>
      ...
      <div className='main'>
        ...
        <div className='main2'>
          ...
          <div className='grid7'>
            <Avatar names="Amy KLassen" text="Give everyone you work with—inside and outside your emoji, keep conversations focused in channels, and simplify all your communication into one place." />
            <Avatar names="Jane Cooper" text="Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet." />
            <Avatar names="ELenoer Pena" text="Nulla Lorem mollit cupidatat irure. Laborum magna nulla duis ullamco cillum dolor. Voluptate exercitation incididunt aliquip deserunt reprehenderit elit laborum. " />
          </div>
          <div className='grid8'>
